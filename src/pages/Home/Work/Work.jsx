      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-md">
            ...
            <p className="mb-5">
              Client satisfaction is our main goal.When a visitor visit this
              site,He/she got a huge resourch and many thing that he
              nedded.There are many car toys order or add for sell your toys
              that you needed.
            </p>
